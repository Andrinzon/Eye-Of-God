...
TOKEN = "6696093539:AAGY4X7KiIrtsGnZlhGcGkpStOG5fEwBDrk"  # Reemplaza con tu token real
...
if __name__ == "__main__":
    ...
    # Arrancamos monitoreo antes de iniciar el bot
    asyncio.get_event_loop().create_task(monitorear(app))
    app.run_polling()
